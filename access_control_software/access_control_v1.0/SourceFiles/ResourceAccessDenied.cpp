...
ResourceAccessDenied::ResourceAccessDenied(string filename) : s_filename(filename)
{
...
ResourceAccessDenied::ResourceAccessDenied(shared_ptr<LoggerAbs> thisLogger, string filename) : ptr_thisLogger{ move(thisLogger) }, s_filename(filename)
{
...
void ResourceAccessDenied::createLog(string p_fileString)
{
...
void ResourceAccessDenied::readFromFile(string fileName, vector<string> vect) {
