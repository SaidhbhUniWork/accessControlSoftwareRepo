...
ResourceAccessSuccess::ResourceAccessSuccess(string filename) : s_filename(filename)
{
...
ResourceAccessSuccess::ResourceAccessSuccess(shared_ptr<LoggerAbs> thisLogger, string filename) : ptr_thisLogger{ move(thisLogger) }, s_filename(filename)
{
...
ResourceAccessSuccess::~ResourceAccessSuccess() {
	try
	{
...
void ResourceAccessSuccess::createLog(string p_fileString)
{
	vector<string> locVector;
	locVector.push_back(p_fileString);
	try
	{
		encDec.fullEncrypt(locVector, keyArray, ivArray, s_filename);
	}
	catch (exception e)
	{
...
void ResourceAccessSuccess::readFromFile(string fileName, vector<string> vect) {
