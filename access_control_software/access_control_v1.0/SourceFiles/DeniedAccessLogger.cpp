...
DeniedAccessLogger::DeniedAccessLogger(shared_ptr<LoggerAbs> thisLogger, string filename) : ptr_thisLogger{ move(thisLogger) }, s_filename(filename)
{
...
DeniedAccessLogger::~DeniedAccessLogger() {
	try
	{
...
void DeniedAccessLogger::createLog(string p_uname)
{
	...
	streamsize ss = loc_datetime[0].size();
	try
	{
...
void DeniedAccessLogger::readFromFile(string fileName, vector<string> vect) {
