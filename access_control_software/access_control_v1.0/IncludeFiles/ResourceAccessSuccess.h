...
class ResourceAccessSuccess : public LoggerAbs
{
private:
...
public:
	ResourceAccessSuccess(shared_ptr<LoggerAbs> thisLogger, const string p_filename);
	ResourceAccessSuccess(const string p_filename);

	~ResourceAccessSuccess();
	void createLog(string p_uname) override;
